...
Partial Class page2
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label4.Text = "Please log in to go to the next step"
        '
        'Label3
        '
    ...
    "_____________________________"
        ...
        Me.Label5.Text = "Click Login in order to activate the Next Button"
        '
        'page2
        '
        ...
        Me.Text = "Easy Butler - Easy Wizard - Login"
